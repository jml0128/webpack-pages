      ...
      },
      {
        ...
        use: [
          ...
          'sass-loader',
          {
            ...
            options: {
              resources: [path.resolve(__dirname, 'src/assets/scss/variables.scss'), path.resolve(__dirname, 'src/assets/scss/mixin.scss'), path.resolve(__dirname, 'src/assets/scss/font.scss')]
            }
          }
        ]
      },
      {
        test: /\.(ttf|otf|png|jpg|gif|svg|mp4|mp3|ico)$/,
        use: [
          {
            loader: 'url-loader',
            options: {
